      ...
      <div className="h-full grid grid-cols-[0.4fr_0.6fr]">
        <div className="p-8 border-r border-amber-200 space-y-6">
          <div className="space-y-1">
            <p className="text-[11px] uppercase tracking-[0.26em] text-amber-700">{t('common.marriageBiodata')}</p>
            <h1 className="text-3xl font-bold leading-tight text-amber-900">{personal.fullName}</h1>
          ...
          <div className="space-y-2 text-sm">
            ...
            <p className="text-stone-700 break-words">{contact.email}</p>
            <p className="text-stone-600 whitespace-pre-line leading-relaxed">{contact.address}</p>
          </div>
        </div>
