    ...
    <div className="w-full h-full bg-gradient-to-br from-pink-50 via-white to-amber-50 text-rose-900 font-serif">
      <div className="grid grid-cols-[0.35fr_0.65fr] h-full">
        <div className="p-8 border-r border-pink-100 space-y-4">
          ...
          <div className="w-full aspect-[3/4] rounded-2xl overflow-hidden border border-pink-100 shadow-sm bg-white">
          ...
          <div className="space-y-2 text-sm">
            <p className="font-semibold text-pink-800">{contact.contactNumber}</p>
            <p className="text-pink-800 break-words">{contact.email}</p>
