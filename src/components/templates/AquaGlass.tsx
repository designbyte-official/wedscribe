  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-cyan-50 via-white to-blue-50 text-slate-900 font-sans">
      <div className="grid grid-cols-[0.35fr_0.65fr] h-full">
        <div className="p-8 border-r border-cyan-100 space-y-6">
          <div className="space-y-2">
            <p className="text-[11px] uppercase tracking-[0.32em] text-cyan-500 font-semibold">{t('common.marriageBiodata')}</p>
          ...
          <div className="w-full aspect-[3/4] rounded-2xl overflow-hidden border border-cyan-100 shadow-sm bg-white/70">
            {personal.photoUrl ? (
          ...
          <div className="space-y-2 text-sm">
            <p className="font-semibold text-cyan-700">{contact.contactNumber}</p>
            <p className="text-cyan-800 break-words">{contact.email}</p>
            <p className="text-cyan-700 whitespace-pre-line leading-relaxed">{contact.address}</p>
          </div>
        </div>
