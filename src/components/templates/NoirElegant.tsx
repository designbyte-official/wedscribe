  ...
  return (
    <div className="w-full h-full bg-neutral-950 text-neutral-50 font-sans">
      <div className="grid grid-cols-[0.34fr_0.66fr] h-full">
        <div className="p-8 border-r border-neutral-800 space-y-6">
          <div className="space-y-1">
            <p className="text-[11px] uppercase tracking-[0.32em] text-neutral-400">{t('common.marriageBiodata')}</p>
          ...
          <div className="w-full aspect-[3/4] rounded-xl overflow-hidden border border-neutral-800 bg-neutral-900">
            {personal.photoUrl ? (
          ...
          <div className="space-y-2 text-sm text-neutral-200">
            ...
            <p className="text-neutral-400 whitespace-pre-line leading-relaxed">{contact.address}</p>
          </div>
        </div>
