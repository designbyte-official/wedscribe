  ...
  return (
    <div className="w-full h-full bg-white text-slate-900 font-sans">
      <div className="grid grid-cols-[0.34fr_0.66fr] h-full">
        <div className="p-8 border-r border-slate-200 space-y-6">
          <div className="space-y-1">
            <p className="text-[11px] uppercase tracking-[0.3em] text-slate-500">{t('common.marriageBiodata')}</p>
          ...
          <div className="w-full aspect-[3/4] rounded-xl overflow-hidden border border-slate-200 bg-slate-50">
            {personal.photoUrl ? (
          ...
          <div className="space-y-2 text-sm">
            ...
            <p className="text-slate-700 break-words">{contact.email}</p>
            <p className="text-slate-600 whitespace-pre-line leading-relaxed">{contact.address}</p>
          </div>
        </div>
