  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-teal-50 via-white to-blue-50 text-teal-900 font-sans">
      <div className="grid grid-cols-[0.35fr_0.65fr] h-full">
        <div className="p-8 border-r border-teal-100 space-y-6">
          <div className="space-y-2">
            <p className="text-[11px] uppercase tracking-[0.3em] text-teal-500 font-semibold">{t('common.marriageBiodata')}</p>
          ...
          <div className="w-full aspect-[3/4] rounded-2xl overflow-hidden border border-teal-100 shadow-sm bg-white">
          ...
          <div className="space-y-2 text-sm">
            <p className="font-semibold text-teal-800">{contact.contactNumber}</p>
            <p className="text-teal-800 break-words">{contact.email}</p>
            <p className="text-teal-700 whitespace-pre-line leading-relaxed">{contact.address}</p>
          </div>
