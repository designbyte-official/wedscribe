  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-emerald-50 via-white to-rose-50 text-emerald-900 font-serif">
      <div className="grid grid-cols-[0.35fr_0.65fr] h-full">
        <div className="p-8 border-r border-emerald-100 space-y-4">
          ...
          <div className="w-full aspect-[3/4] rounded-2xl overflow-hidden border border-emerald-100 shadow-sm bg-white">
          ...
          <div className="space-y-2 text-sm">
            ...
            <p className="text-emerald-800 break-words">{contact.email}</p>
